...
ChoPlayer* ChoPlayer::createShip(const char* pszFileName)
{
    ChoPlayer *pobSprite = new ChoPlayer();
...
ChoPlayer* ChoPlayer::createShipFrame(const char* pszFileName, int numFrame)
{
    ChoPlayer *pobSprite = new ChoPlayer();
 ...
 * 更新処理
 */
void ChoPlayer::update(float dt)
{
    if (_autoShooting)
    {
 ...
 * レーザーを生成する
 */
void ChoPlayer::createLaser(BulletSprite *shipLaser, cocos2d::CCSize winSize, float direction, float speed)
{
	// レーザーのリストと照合
